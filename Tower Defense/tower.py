...
# Cargar imágenes
background_image = pygame.image.load('fondo.jpg').convert()  # Cargar imagen de fondo
background_image = pygame.transform.scale(background_image, (SCREEN_WIDTH, SCREEN_HEIGHT))  # Redimensionar fondo

tower_image = pygame.image.load('torre.png').convert_alpha()  # Cargar imagen de la torre
